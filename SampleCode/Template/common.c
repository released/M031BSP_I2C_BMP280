...
//    return coines_read_i2c(dev_addr, reg_addr, reg_data, (uint16_t)length);
    return i2c_reg_read(dev_addr, reg_addr, reg_data, (uint16_t)length);
}
...
//    return coines_write_i2c(dev_addr, reg_addr, (uint8_t *)reg_data, (uint16_t)length);
    return i2c_reg_write(dev_addr, reg_addr, (uint8_t *)reg_data, (uint16_t)length);
}
...
//        coines_set_shuttleboard_vdd_vddio_config(0, 0);
		delay_ms(100);//coines_delay_msec(100);
